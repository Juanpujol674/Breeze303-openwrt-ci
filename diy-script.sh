...
git clone --depth=1 --single-branch --branch main https://github.com/lwb1978/openwrt-gecoosac package/openwrt-gecoosac package/luci-app-gecoosac
git clone --depth=1 --single-branch --branch main https://github.com/asvow/luci-app-tailscale package/luci-app-tailscale package/luci-app-tailscale
# 科学上网插件
